...
PRIMARY_COLOR = '#fd6a36'
HOVER_PRIMARY_COLOR = '#FD8B51'
BUTTON_TEXT_PRIMARY_COLOR = 'white'
...
theme_config = {
    ...
    "CTkButton": {
        "corner_radius": 6,
        "border_width": 0,
        "fg_color": [PRIMARY_COLOR, "#2FA572"],
        "hover_color": [HOVER_PRIMARY_COLOR, "#106A43"],
        "border_color": ["#3E454A", "#949A9F"],
        "text_color": [BUTTON_TEXT_PRIMARY_COLOR, "white"],
    ...
    "CTkEntry": {
        ...
        "border_color": "gray",
        "text_color": TEXT_PRIMARY_COLOR,
        "placeholder_text_color": TEXT_PRIMARY_COLOR
    },
    "CTkCheckBox": {
        "corner_radius": 6,
        "border_width": 3,
...
with open("src/themes/main.json", "w") as json_file:
    json.dump(theme_config, json_file, indent=4)
